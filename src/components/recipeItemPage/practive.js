...
export default function Footer() {
  ...
  return (
    <div>
      <div star-type={someFunc(1, 0.5)} css={footerWrapperCss}>
        <span onMouseOver={() => setRating(0.5)} />
        <span onMouseOver={() => setRating(1)} />
      </div>
      <div star-type={someFunc(2, 1.5)} css={footerWrapperCss}>
        <span onMouseOver={() => setRating(1.5)} />
        <span onMouseOver={() => setRating(2)} />
      </div>
      <div star-type={someFunc(3, 2.5)} css={footerWrapperCss}>
        <span onMouseOver={() => setRating(2.5)} />
        <span onMouseOver={() => setRating(3)} />
      </div>
      <div star-type={someFunc(4, 3.5)} css={footerWrapperCss}>
        <span onMouseOver={() => setRating(3.5)} />
        <span onMouseOver={() => setRating(4)} />
      </div>
      <div star-type={someFunc(5, 4.5)} css={footerWrapperCss}>
